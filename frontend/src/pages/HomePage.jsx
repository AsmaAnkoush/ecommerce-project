...
function Hero({ innerRef, inView, t }) {
  return (
    <section ref={innerRef} className="bg-[#F2E0E4] lg:min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-14 py-10 sm:py-14 lg:py-0 lg:min-h-screen lg:flex lg:items-center lg:-mt-12">
        ...
        <div className="flex flex-row items-center justify-center gap-6 sm:gap-10 lg:gap-55 w-full">
          ...
          <div className={`max-w-[260px] sm:max-w-[360px] lg:max-w-[480px] min-w-0 text-left ${inView ? 'animate-fade-in-up' : 'opacity-0'}`}>
            ...
            <h1 style={{ fontFamily: 'Playfair Display, Cormorant Garamond, serif' }}>
              <span
                className="block text-[36px] sm:text-[48px] lg:text-[64px] font-bold leading-[1] tracking-[0.06em] text-[#6B1F2A] drop-shadow-[0_2px_4px_rgba(107,31,42,0.12)]"
                style={{ fontStyle: 'italic' }}
              >
                I Wear
              </span>
              <span
                className="block text-[18px] sm:text-[22px] lg:text-[26px] font-light leading-[1.1] mt-3 tracking-[0.04em] text-[#9B7B80]"
                style={{ fontStyle: 'italic' }}
              >
                by Areej
              </span>
            ...
            <div className="flex items-center gap-3.5 mt-6 mb-6 lg:mt-8 lg:mb-8">
          ...
          <div className={`shrink-0 w-36 sm:w-48 lg:w-72 ${inView ? 'animate-fade-in delay-150' : 'opacity-0'}`}>
            <div
              ...
              style={{
                ...
                boxShadow: '0 18px 50px rgba(107,31,42,0.18), 0 0 0 7px rgba(107,31,42,0.06), 0 0 80px rgba(107,31,42,0.06)',
              }}
            >
              <img
